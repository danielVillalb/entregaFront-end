...
export class EducacionComponent {
  ...
  ngOnInit():void{
    this.datos.probando().subscribe(data => {
      this.educacion= data[1].educacion;
      
      this.instituto1=data[1].instituto;
      this.titulo1=data[1].titulo;
      this.periodo1=data[1].periodo;
      this.termino1=data[1].termino;
...
onEnterInstituto(event:any)
{
  ...
  this.instituto1=this.educacion1[1].instituto;
}
onEnterPeriodo(event:any)
{
  this.editarPeriodo=false;
  this.periodo1=this.educacion1[1].periodo;
}
onEnterTermino(event:any)
{
  this.editarTermino=false;
  this.termino1=this.educacion1[1].termino;
}
onEnterTitulo(event:any)
{
  this.editarTitulo=false;
  this.titulo1=this.educacion1[1].titulo;
}
